      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-16">
          <div>
            <h2
              ref={titleRef}
              className="text-h1 lg:text-display-xl text-theme-primary font-medium mb-4 opacity-0"
            >
              {blogConfig.title}
            </h2>
            <p
              ref={descRef}
              className="text-body-lg text-theme-secondary max-w-xl"
            >
              {blogConfig.subtitle}
            </p>
          </div>
          ...
          <button
            ref={buttonRef}
            onClick={() => blogConfig.allPostsUrl && navigate(blogConfig.allPostsUrl)}
            className="hidden lg:flex items-center gap-2 text-body text-theme-muted hover:text-theme-primary transition-colors duration-300 mt-8 lg:mt-0 group"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          {blogConfig.posts.map((post, index) => (
            <div
              ...
              onClick={() => post.url && navigate(post.url)}
            >
              {/* Image */}
              ...
              <div className="post-content">
                {/* Meta */}
                <div className="flex items-center gap-6 mb-4 text-body-sm text-theme-muted">
                ...
                {/* Title */}
                <h3 className="text-h4 lg:text-h3 text-theme-primary font-medium mb-3 group-hover:text-highlight transition-colors duration-300 relative">
                  {post.title}
                ...
                {/* Read more */}
                <div className="flex items-center gap-2 mt-4 text-body-sm text-theme-muted group-hover:text-theme-primary transition-colors duration-300">
