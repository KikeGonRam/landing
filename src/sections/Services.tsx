    ...
    >
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-20">
          <h2
            ref={titleRef}
            className="text-h1 lg:text-display-xl text-theme-primary font-medium mb-6"
          >
            {servicesConfig.title}
          </h2>
          <p
            ref={subtitleRef}
            className="text-body-lg text-theme-secondary max-w-2xl"
          >
        ...
        <div className="space-y-0">
          {services.map((service, index) => (
            ...
            >
              {/* Top border line */}
              <div
                className="service-line h-px bg-theme-primary/20 group-hover:bg-highlight transition-colors duration-300"
              ...
              <div className="py-8 lg:py-12 flex items-center justify-between cursor-pointer">
                <div className="flex items-center gap-8 lg:gap-16">
                  {/* Number */}
                  <span
                    className="service-number text-h5 lg:text-h4 text-theme-muted font-light group-hover:text-highlight group-hover:scale-110 transition-all duration-300"
                  ...
                  {/* Title */}
                  <h3
                    className={`text-h3 lg:text-h2 text-theme-primary font-normal transition-all duration-400 ${
                ...
                {/* Description */}
                <p
                  className={`hidden lg:block text-body text-theme-muted max-w-xs text-right transition-opacity duration-300 ${
                    activeIndex !== null && activeIndex !== index
                      ? 'opacity-30'
                      : 'opacity-100'
                  }`}
              ...
              {index === services.length - 1 && (
                <div className="service-line h-px bg-theme-primary/20" />
              )}
            </div>
          ))}
        </div>
