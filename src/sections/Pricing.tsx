...
export function Pricing() {
  ...
  if (!pricingConfig.title || plans.length === 0) return null;
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2
            ref={titleRef}
            className="text-h1 lg:text-display-xl text-theme-primary font-medium mb-4"
          >
            {pricingConfig.title}
          </h2>
          <p ref={subtitleRef} className="text-body-lg text-theme-secondary">
          ...
          {plans.map((plan, index) => (
            <div
              ...
              className={`relative p-8 lg:p-10 preserve-3d transition-colors duration-300 ${
                plan.featured
                  ? 'bg-theme-primary text-theme-primary border-2 border-highlight'
                  : 'bg-theme-card text-theme-primary hover:bg-theme-card/80'
              }`}
              style={{
            ...
            >
              ...
              <div className="mb-8">
                <span className="text-h4 lg:text-h3 font-medium tabular-nums">
                  ${(reduceMotion ? plan.price : animatedPrices[index] || 0).toLocaleString()}.00
                </span>
                <span
              ...
              <ul className="space-y-4 mb-10">
                {plan.features.map((feature, i) => (
                  ...
                  >
                    <Check
                      className="w-5 h-5 flex-shrink-0 text-highlight"
                    />
                    {feature}
                  </li>
                ))}
              ...
              <button
                className={`w-full py-4 text-body font-medium transition-all duration-200 ${
                  plan.featured
                    ...
                    : 'border border-theme-primary/30 text-theme-primary hover:bg-theme-primary hover:text-theme-primary'
                }`}
              >
