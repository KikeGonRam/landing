...
export function About() {
  ...
  return (
    <section
      ref={sectionRef}
      id="about"
      className="relative py-32 px-8 lg:px-16 overflow-hidden bg-theme-primary transition-colors duration-300"
      style={{ transform: 'rotate(0deg)' }}
    >
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-theme-secondary to-transparent z-0 opacity-50" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            <h2
              ref={titleRef}
              className="text-h3 lg:text-h2 text-theme-primary font-normal leading-tight mb-8"
            >
            ...
            <p
              ref={textRef}
              className="text-body-lg text-theme-secondary leading-relaxed mb-12"
            >
            ...
            <div className="flex items-start gap-6">
              ...
              {/* Author text */}
              <div ref={authorTextRef} className="text-body text-theme-muted">
