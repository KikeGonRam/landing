...
export function Testimonials() {
  ...
  return (
    <section
      ref={sectionRef}
      id="testimonials"
      className="relative py-32 px-8 lg:px-16 bg-gradient-to-b from-theme-secondary to-theme-primary overflow-hidden transition-colors duration-300"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {testimonialsConfig.testimonials.map((testimonial, index) => (
            <div
              ...
              className="relative bg-theme-card/50 backdrop-blur-sm p-8 lg:p-10 group hover:bg-theme-card/70 transition-colors duration-300 preserve-3d"
              style={{
            ...
            >
              {/* Quote mark */}
              <Quote className="quote-mark absolute top-6 right-6 w-12 h-12 text-theme-primary opacity-10" />

              {/* Quote text */}
              <p className="text-body-lg text-theme-secondary leading-relaxed mb-8 relative z-10">
                "{testimonial.quote}"
              </p>
